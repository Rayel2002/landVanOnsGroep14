        ...
        <div class="container p-6">
            <div class="rounded-lg shadow-2xl bg-white m-auto w-64">
                <div class="card-body p-4">
                    ...
                    @endif
                        <h1 class="text-2xl font-bold mb-4">Admin Home pagina</h1>
                    <div class="flex flex-col items-center p-4">
                        @can('edit-event')
                            <a href="{{ route('event.create') }}" class="bg-fuchsia-500 text-white hover:shadow-xl py-2 px-4 rounded mb-2 border-b font-bold" style="background-color: rgb(219, 51, 151)">Maak nieuw event</a>
                        @endcan
                        ...
                        @can('edit-event')
                            <a href="{{ route('event.adminform') }}" class="bg-fuchsia-500 text-white hover:shadow-xl py-2 px-4 rounded mb-2 border-b font-bold" style="background-color: rgb(219, 51, 151)">Admin functies</a>
                        @endcan
                        {{-- Logout Button --}}
