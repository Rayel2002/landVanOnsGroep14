...
@section('content')
    ...
    <div class="container flex justify-center items-center h-screen offset">
        <div class="row justify-content-center ">
            <div class="col-md-8 ">
                <div class="border border-gray-300 rounded-lg drop-shadow-2xl bg-white">
                    <h1 class="font-bold p-2">Inloggen</h1>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6 p-1">
                                    <input id="email" type="email" class="grey-border form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            ...
                            <div class="mb-3 row p-1">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="grey-border form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
