                        ...
                        <form method="post" action="{{ route('event.update',$event_name) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="event_name" type="text" name="event_name" class="form-control" required
                                       @if($edit_event !== NULL) value="{{$edit_event->event_name}}" @endif>
                            </div>
                            @if ($date_error !== null)
                                <p class="errors"></p>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input id="amount_of_volunteers_needed" type="number" name="amount_of_volunteers_needed"
                                       ...
                                       @if($edit_event !== NULL) value="{{$edit_event->amount_of_volunteers_needed}}" @endif>
                            </div>
                            <div class="form-group">
                                <label for="description">Beschrijving:</label>
                                <textarea id="description" name="description" class="form-control" required>@if($edit_event !== NULL)
